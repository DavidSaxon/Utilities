...
| @author David Saxon                         |
\*********************************************/
#ifndef UTILITIES_RGBUTIL_H_
#   define UTILITIES_RGBUTIL_H_
...
inline unsigned multiplyRGB(unsigned a, unsigned b, float p) {
...
inline void decomposeRGB(unsigned i, byte* _rgb) {
...
inline unsigned equalsRGB(unsigned a, unsigned b) {
